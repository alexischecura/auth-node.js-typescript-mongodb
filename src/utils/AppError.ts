...
type FieldError = { field: string | number; error: string };
...
export abstract class AppError extends Error {
  ...
  constructor(
    ...
    fields: FieldError[] | undefined = undefined,
...
export class BadRequestError extends AppError {
  constructor(message: string, errors: FieldError[] | undefined = undefined) {
    const statusCode = HttpStatus.BAD_REQUEST;
    const code = ErrorCode.BAD_REQUEST_ERROR; // You can define this error code
    const description = 'Bad request error.';
...
export class ValidationError extends AppError {
  constructor(message: string, fields: FieldError[] | undefined = undefined) {
    const statusCode = HttpStatus.BAD_REQUEST;
